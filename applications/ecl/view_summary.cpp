...
static void build_key_list(const ecl_sum_type *ecl_sum,
                           stringlist_type *key_list, int argc,
                           const char **argv) {
    int iarg;
    ...
    */
        ...
        if (util_string_has_wildcard(argv[iarg]))
            ecl_sum_select_matching_general_var_list(ecl_sum, argv[iarg],
                                                     key_list);
        else
...
int main(int argc, char **argv) {
    install_SIGNALS();
    {
...

        {
            ...
            ecl_sum = ecl_sum_fread_alloc_case2__(data_file, ":",
                                                  include_restart, true, 0);
          ...
          */
                    ...
                    if (num_keys == 0) {
                        ecl_sum_select_matching_general_var_list(ecl_sum, "*",
                                                                 keys);
                    ...
                    ecl_sum_fprintf(ecl_sum, stdout, key_list, report_only,
                                    &fmt);
