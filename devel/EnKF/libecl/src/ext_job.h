...
enum ext_status_enum_def {ext_status_null , ext_status_submitted , ext_status_running , ext_status_complete_OK , ext_status_complete_kill , 
			  ext_status_complete_fail , ext_status_complete_done};

void              ext_job_free(ext_job_type *);
ext_job_type    * ext_job_alloc(const char * ,const char *, const char *, const char * , const char *, const char * , int , int , bool , bool);
