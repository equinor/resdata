...
enkf_state_type * enkf_state_alloc(const enkf_config_type * , const char *);
...
void              enkf_state_load_ecl_restart(enkf_state_type * , const char * , bool , bool , int );
...
void 		  enkf_state_ecl_write(const enkf_state_type * , const char * , int , bool , bool );
