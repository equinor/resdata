...
void 	     field_ecl_write_fortio1D(const field_type * , fortio_type * , bool , bool , ecl_type_enum);
void 	     field_ecl_write_fortio3D(const field_type * , fortio_type * , bool , bool , ecl_type_enum);
