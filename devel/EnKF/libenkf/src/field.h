...
void 	     field_ecl_write1D_fortio(const field_type * , fortio_type * , bool , bool , ecl_type_enum);
void 	     field_ecl_write3D_fortio(const field_type * , fortio_type * , bool , bool , ecl_type_enum);
