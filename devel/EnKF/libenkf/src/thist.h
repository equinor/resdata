...
thist_type * thist_alloc(int , thist_data_type);
void         thist_update_forecast_scalar(thist_type *  , int , int , double );
void         thist_update_forecast_vector(thist_type *  , int , const double *);
void         thist_update_analyzed_scalar(thist_type *  , int , int , double );
void         thist_update_analyzed_vector(thist_type *  , int , const double *);
