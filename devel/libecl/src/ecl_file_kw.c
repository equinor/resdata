...
static ecl_file_kw_type * ecl_file_kw_alloc__( const char * header , ecl_type_enum ecl_type , int size , off_t offset) {
...
ecl_file_kw_type * ecl_file_kw_alloc( const ecl_kw_type * ecl_kw , off_t offset ) {
