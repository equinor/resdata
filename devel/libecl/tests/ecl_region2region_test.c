...
int main(int argc , char ** argv) {
 ...
 stringlist_append_copy(data_files, datafile); 
 ecl_sum_type * ecl_sum = ecl_sum_fread_alloc(headerfile,  data_files,  ":");  
 ...
 if (NULL != ecl_sum)
 {
    ...
    test_error_exit("ecl_region2region_test: Test files not read correctly"); 
 }
