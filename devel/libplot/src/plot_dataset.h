...
/* Get functions */
extern int plot_dataset_get_length(plot_dataset_type * d);
extern plot_color_type plot_dataset_get_color(plot_dataset_type * d);
extern plot_style_type plot_dataset_get_style(plot_dataset_type * d);
extern PLFLT *plot_dataset_get_vector_x(plot_dataset_type * d);
extern PLFLT *plot_dataset_get_vector_y(plot_dataset_type * d);
