...
static void custom_cell_renderer_progress_init (CustomCellRendererProgress *
						cellprogress);

static void
custom_cell_renderer_progress_class_init (CustomCellRendererProgressClass *
					  klass);
...
static void
custom_cell_renderer_progress_init (CustomCellRendererProgress *
...
{
  CustomCellRendererProgress *cellprogress =
    CUSTOM_CELL_RENDERER_PROGRESS (object);
...
{
  CustomCellRendererProgress *cellprogress =
    CUSTOM_CELL_RENDERER_PROGRESS (cell);
  GtkStateType state;
  gint width, height;
