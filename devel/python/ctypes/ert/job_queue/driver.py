...
cfunc_lsf.alloc_driver = cwrapper.prototype("c_void_p    lsf_driver_alloc( char* , char* , char* , int )")
cfunc_lsf.free_driver  = cwrapper.prototype("void    lsf_driver_free( lsf_driver )")
cfunc_lsf.submit       = cwrapper.prototype("c_void_p    lsf_driver_submit_job( lsf_driver , char* , char* , char* , int , char**)")
...
cfunc_local.alloc_driver     = cwrapper.prototype("c_void_p    local_driver_alloc( )")
cfunc_local.free_driver      = cwrapper.prototype("void    local_driver_free( local_driver )")
cfunc_local.submit           = cwrapper.prototype("c_void_p    local_driver_submit_job( local_driver , char* , char* , char* , int , char**)")
...
cfunc_rsh.alloc_driver     = cwrapper.prototype("c_void_p    rsh_driver_alloc( char* , char* )")
cfunc_rsh.free_driver      = cwrapper.prototype("void    rsh_driver_free( rsh_driver )")
cfunc_rsh.submit           = cwrapper.prototype("c_void_p    rsh_driver_submit_job( rsh_driver , char* , char* , char* , int , char**)")
