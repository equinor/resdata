...
specgrid = ecl.EclKW.grdecl_load( fileH , "SPECGRID" , ecl_type = 3)#ecl_type = ecl.ECL_INT_TYPE )
zcorn    = ecl.EclKW.grdecl_load( fileH , "ZCORN" )
coord    = ecl.EclKW.grdecl_load( fileH , "COORD" )
actnum   = ecl.EclKW.grdecl_load( fileH , "ACTNUM" , ecl_type = 3)#ecl_type = ecl.ECL_INT_TYPE )
