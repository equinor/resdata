...
class conf:
    def __init__(self , cwd , package , sub_level_depth):
        ...
        if M64:
            ...
            self.CCFLAGS = ""
        self.CCFLAGS = ""
        self.CCFLAGS            += "-O2 -std=gnu99 -g -Wall -pipe -DHAVE_READLINKAT -DHAVE_PROC -DINTERNAL_LINK -DHAVE_FSYNC -DHAVE_GLOB -DHAVE_FNMATCH -DMKDIR_POSIX -DHAVE_LOCALTIME_R -DHAVE_LOCKF -DPOSIX_SETENV -DHAVE_GETUID -DHAVE_SYMLINK -DHAVE_REALPATH -DHAVE_EXECINFO -DHAVE_FORK -DHAVE_ZLIB -DHAVE_PTHREAD"
        if self.USE_OPENMP:
