...
class conf:
    def __init__(self , cwd , sub_level_depth):
        ...
        if M64:
            ...
            self.CCFLAGS = ""
        self.CCFLAGS = ""
        self.CCFLAGS            += "-O2 -std=gnu99 -g -fno-leading-underscore -Wall -pipe -DHAVE_VA_COPY -DHAVE_ISREG -DHAVE_PID_T -DHAVE_ROUND -DHAVE_GETOPT -DHAVE_USLEEP -DHAVE_OPENDIR -DHAVE_LAPACK -DHAVE_REGEXP -DHAVE_FTRUNCATE -DHAVE_READLINKAT -DHAVE_PROC -DINTERNAL_LINK -DHAVE_FSYNC -DHAVE_GLOB -DHAVE_FNMATCH -DMKDIR_POSIX -DHAVE_LOCALTIME_R -DHAVE_LOCKF -DHAVE_ISFINITE -DPOSIX_SETENV -DHAVE_GETUID -DHAVE_SYMLINK -DHAVE_REALPATH -DHAVE_EXECINFO -DHAVE_FORK -DHAVE_ZLIB -DHAVE_PTHREAD"
        if self.USE_OPENMP:
