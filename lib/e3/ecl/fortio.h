 ...
 *      T - don't transform/byteswap data (but fix endianness)
 *
...
/*
 * Get the size of the current record. The file position is approperiately
 * rewinded afterwards, as if the function was never called.
 *
