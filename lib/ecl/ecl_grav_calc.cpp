...
static void ecl_grav_check_rporv(const ecl_grid_type *ecl_grid,
  ...
  for (active_index = active_delta; active_index < active_size;
    ...
    if (fraction < 0.50) {
      ...
      fprintf(stderr, "Hmmm - the RPORV values extracted from the restart file "
                      "seem to be \n");
      fprintf(stderr, "veeery different from the initial rporv value. This "
                      "might indicate\n");
      fprintf(stderr, "an ECLIPSE bug. Version 2007.2 is known to be ok in "
                      "this respect, \n");
