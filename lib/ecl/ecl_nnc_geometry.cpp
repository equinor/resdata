...
static void ecl_nnc_geometry_add_pairs(const ecl_nnc_geometry_type *nnc_geo,
    ...
    for (int global_index1 = 0; global_index1 < ecl_grid_get_global_size(grid);
         global_index1++) {
...
static bool ecl_nnc_cmp(const ecl_nnc_pair_type &nnc1,
...
ecl_nnc_geometry_type *ecl_nnc_geometry_alloc(const ecl_grid_type *grid) {
    ecl_nnc_geometry_type *nnc_geo =
        (ecl_nnc_geometry_type *)util_malloc(sizeof *nnc_geo);
