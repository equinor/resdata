...
static UTIL_TRY_CAST_FUNCTION_CONST(
    ...
    static UTIL_SAFE_CAST_FUNCTION(
        ecl_rft_cell,
        ECL_RFT_CELL_TYPE_ID) static UTIL_SAFE_CAST_FUNCTION_CONST(ecl_rft_cell,
                                                                   ECL_RFT_CELL_TYPE_ID)
        UTIL_IS_INSTANCE_FUNCTION(ecl_rft_cell, ECL_RFT_CELL_TYPE_ID)

            static ecl_rft_cell_type *ecl_rft_cell_alloc_common(
                int i, int j, int k, double depth, double pressure) {
...
ecl_rft_cell_type *ecl_rft_cell_alloc_RFT(int i, int j, int k, double depth,
    ...
    ecl_rft_cell_type *cell =
        ecl_rft_cell_alloc_common(i, j, k, depth, pressure);
...
int ecl_rft_cell_get_k(const ecl_rft_cell_type *cell) { return cell->k; }
