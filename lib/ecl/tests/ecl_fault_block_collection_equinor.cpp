/*
   ...
   The file 'ecl_fault_block_collection_equinor.c' is part of ERT - Ensemble
   based Reservoir Tool.
...
int main(int argc, char **argv) {
  ...
  ecl_kw_type *fault_blk_kw;
  {
    ...
    fault_blk_kw = ecl_kw_fscanf_alloc_grdecl(
        stream, "FAULTBLK", ecl_grid_get_global_size(ecl_grid), ECL_INT_TYPE);
    fclose(stream);
  }
