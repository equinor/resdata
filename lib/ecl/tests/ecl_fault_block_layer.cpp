/*
   ...
   The file 'ecl_fault_block_layer.c' is part of ERT - Ensemble based Reservoir
   Tool.
...
void test_create_invalid(const ecl_grid_type *grid) {
  ecl_kw_type *fault_blk_kw =
      ecl_kw_alloc("FAULTBLK", ecl_grid_get_global_size(grid) - 1, ECL_INT);
...
void test_export(const ecl_grid_type *grid) {
  ...
  ecl_kw_type *ecl_kw1 =
      ecl_kw_alloc("FAULTBLK", ecl_grid_get_global_size(grid), ECL_INT);
  ecl_kw_type *ecl_kw2 =
      ecl_kw_alloc("FAULTBLK", ecl_grid_get_global_size(grid) + 1, ECL_INT);
  ecl_kw_type *ecl_kw3 =
      ecl_kw_alloc("FAULTBLK", ecl_grid_get_global_size(grid), ECL_FLOAT);
...
int main(int argc, char **argv) {
  ...
  ecl_kw_type *fault_blk_kw =
      ecl_kw_alloc("FAULTBLK", ecl_grid_get_global_size(ecl_grid), ECL_INT);
