...
void test_file_kw_equal() {
    ...
    ecl_file_kw_type *kw4 =
        ecl_file_kw_alloc0("PRESSURE", ECL_DOUBLE, 1000, 66);
...
void test_create_file_kw() {
    ecl_file_kw_type *file_kw0 =
        ecl_file_kw_alloc0("PRESSURE", ECL_FLOAT, 1000, 66);
    ecl_file_kw_type *file_kw1 =
        ecl_file_kw_alloc0("TEST1_KW", ECL_FLOAT, 2000, 1066);
    ecl_file_kw_type *file_kw2 =
        ecl_file_kw_alloc0("TEST2_KW", ECL_FLOAT, 3000, 2066);
    ...
    test_assert_true(
        ecl_type_is_equal(ecl_file_kw_get_data_type(file_kw0), ECL_FLOAT));
    {
        ...
        {
            FILE *istream = util_fopen("file_kw", "r");
            ecl_file_kw_type **disk_kw =
                ecl_file_kw_fread_alloc_multiple(istream, 3);
