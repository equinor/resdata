...
void test_1() {
    ...
    ecl::util::TestArea ta("test1");
    {
        ...
        ecl_grid_type *grid_write =
            ecl_grid_alloc_rectangular(2, 3, 1, 1, 1, 1, NULL);
        ...
        ecl_kw_type *filehead_kw =
            ecl_file_iget_named_kw(ecl_file, FILEHEAD_KW, 0);
        ...
        ecl_grid_type *grid =
            ecl_grid_alloc_ext_actnum(filename1, ext_actnum.data());
