...
void test_get_invalid_cell() {
  ...
  test_assert_util_abort("layer_get_global_cell_index", get_invalid_layer_cell1,
                         layer);
  test_assert_util_abort("layer_get_global_cell_index", get_invalid_layer_cell2,
                         layer);
  layer_free(layer);
}
...
void test_get_invalid_edge() {
  layer_type *layer = layer_alloc(10, 10);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge1,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge2,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge3,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge4,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge5,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge6,
                         layer);
  test_assert_util_abort("layer_get_global_edge_index", get_invalid_layer_edge7,
                         layer);
  layer_free(layer);
}
  ...
  test_assert_int_equal(9, layer_get_cell_sum(layer));
  {
    ...
    for (j = 0; j < 5; j++) {
      for (i = 0; i < 5; i++) {
        ...
        if (cell_value != 0) {
          test_assert_true(layer_trace_block_edge(layer, i, j, cell_value,
