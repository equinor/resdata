...
void test_rft_cell() {
  ...
  ecl_rft_cell_type *cell =
      ecl_rft_cell_alloc_RFT(i, j, k, depth, pressure, swat, sgas);
  ...
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_orat(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_grat(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_wrat(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_flowrate(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_connection_start(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_connection_end(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_oil_flowrate(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_gas_flowrate(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_water_flowrate(cell));
...
void test_plt_cell() {
  ...
  ecl_rft_cell_type *cell = ecl_rft_cell_alloc_PLT(
  ...
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_swat(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_sgas(cell));
  test_assert_double_equal(ECL_RFT_CELL_INVALID_VALUE,
                           ecl_rft_cell_get_soil(cell));
