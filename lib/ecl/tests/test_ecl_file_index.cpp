/*
   ...
   The file 'test_ecl_file_index.c' is part of ERT - Ensemble based Reservoir
   Tool.
...
void test_load_nonexisting_file() {
  ecl_file_type *ecl_file =
      ecl_file_fast_open("base_file", "a_file_that_does_not_exist_2384623", 0);
...
void test_create_and_load_index_file() {
  ...
  ecl::util::TestArea ta("Load_index");
  {
    ...
    ecl_file_type *ecl_file_index =
        ecl_file_fast_open(file_name, index_file_name, 0);
