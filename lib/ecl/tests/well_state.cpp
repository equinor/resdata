...
int main(int argc, char **argv) {
  ...
  test_assert_int_equal(
      well_state_translate_ecl_type_int(IWEL_UNDOCUMENTED_ZERO), ECL_WELL_ZERO);
  test_assert_int_equal(well_state_translate_ecl_type_int(IWEL_PRODUCER),
                        ECL_WELL_PRODUCER);
  test_assert_int_equal(well_state_translate_ecl_type_int(IWEL_WATER_INJECTOR),
                        ECL_WELL_WATER_INJECTOR);
  test_assert_int_equal(well_state_translate_ecl_type_int(IWEL_GAS_INJECTOR),
                        ECL_WELL_GAS_INJECTOR);
  test_assert_int_equal(well_state_translate_ecl_type_int(IWEL_OIL_INJECTOR),
