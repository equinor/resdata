...
#define  ECL_GRID_MAINGRID_LGR_NR 0
  ...
  void ecl_grid_export_data_as_int( const ecl_grid_type * grid, int index_size, const int * global_index, ecl_kw_type * kw, int * output);
  void ecl_grid_export_data_as_double( const ecl_grid_type * grid, int index_size, const int * data_index, ecl_kw_type * kw, double * output);
