...
double ecl_grid_get_cell_volume1A(const ecl_grid_type *ecl_grid,
                                  int active_index);
bool ecl_grid_cell_contains1(const ecl_grid_type *grid, int global_index,
                             double x, double y, double z);
bool ecl_grid_cell_contains3(const ecl_grid_type *grid, int i, int j, int k,
                             double x, double y, double z);
...
ecl_grid_type *ecl_grid_alloc_GRDECL_data(int, int, int, const float *,
...
void ecl_grid_get_ijk1(const ecl_grid_type *, int global_index, int *, int *,
                       int *);
void ecl_grid_get_ijk1A(const ecl_grid_type *, int active_index, int *, int *,
                        int *);
void ecl_grid_get_ijk_from_active_index(const ecl_grid_type *, int, int *,
                                        int *, int *);

void ecl_grid_get_xyz3(const ecl_grid_type *, int, int, int, double *, double *,
                       double *);
...
bool ecl_grid_get_xyz_inside1(const ecl_grid_type *grid, int global_index,
                              double *xpos, double *ypos, double *zpos);
bool ecl_grid_get_xyz_inside3(const ecl_grid_type *grid, int i, int j, int k,
                              double *xpos, double *ypos, double *zpos);
...
int ecl_grid_get_block_count3d(const ecl_grid_type *ecl_grid, int i, int j,
                               int k);
...
void ecl_grid_export_data_as_int(int index_size, const int *global_index,
