...
ecl_smspec_get_group_var_node(const ecl_smspec_type *smspec, const char *group,
                              const char *var);
const ecl::smspec_node &
ecl_smspec_get_field_var_node(const ecl_smspec_type *smspec, const char *var);
const ecl::smspec_node &
...
// bool                ecl_smspec_general_is_total(const ecl_smspec_type *
// ecl_smspec , const char * gen_key); bool ecl_smspec_is_rate(const
// ecl_smspec_type * smspec , int kw_index); ecl_smspec_var_type
// ecl_smspec_iget_var_type( const ecl_smspec_type * smspec , int index ); const
// char *        ecl_smspec_iget_unit( const ecl_smspec_type * smspec , int index
// ); int                 ecl_smspec_iget_num( const ecl_smspec_type * smspec ,
// int index ); const char *        ecl_smspec_iget_wgname( const ecl_smspec_type
// * smspec , int index ); const char *        ecl_smspec_iget_keyword( const
// ecl_smspec_type * smspec , int index );
