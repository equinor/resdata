...
typedef struct ecl_sum_data_struct ecl_sum_data_type ;
  ...
  double_vector_type     * ecl_sum_data_alloc_seconds_solution( const ecl_sum_data_type * data , const ecl::smspec_node_type& node , double value, bool rates_clamp_lower);
