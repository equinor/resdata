...
/* These values are taken from the ISEG description in table 6.1 in ECLIPSE file
 * formats reference. */
...
#define WELL_SEGMENT_OUTLET_END_VALUE                                          \
  (WELL_SEGMENT_OFFSET + ECLIPSE_WELL_SEGMENT_OUTLET_END_VALUE -               \
   ECLIPSE_WELL_SEGMENT_OFFSET) // -1
#define WELL_SEGMENT_BRANCH_MAIN_STEM_VALUE                                    \
  (WELL_BRANCH_OFFSET + ECLIPSE_WELL_SEGMENT_BRANCH_MAIN_STEM_VALUE -          \
   ECLIPSE_WELL_BRANCH_OFFSET) //  0
#define WELL_SEGMENT_BRANCH_INACTIVE_VALUE                                     \
  (WELL_BRANCH_OFFSET + ECLIPSE_WELL_SEGMENT_INACTIVE_VALUE -                  \
   ECLIPSE_WELL_BRANCH_OFFSET) // -1
#define CONN_NORMAL_WELL_SEGMENT_VALUE                                         \
  (WELL_SEGMENT_OFFSET + ECLIPSE_CONN_NORMAL_WELL_SEGMENT_VALUE -              \
