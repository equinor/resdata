...
#define NUMS_KW                                                                \
    "NUMS" /* Extra numeric qualifiers for the summary variables, like cell number. */
#define LGRS_KW "LGRS" /* The lgr name for a vector originating from an lgr. */
#define NUMLX_KW                                                               \
    "NUMLX" /* For block variables defined in a an lgr this is i coordinate in the lgr. */
...
/* Summary data files: */
#define SEQHDR_KW                                                              \
    "SEQHDR" // Contains a single 'magic' integer - not used in resdata.
...
/*
   ...
   interesting data the table created from the rd_smspec file must be
   consulted.
*/
...
#define NNCL_KW                                                                \
    "NNCL" /*Cell numbers for LGR cells that are connected to global grid cells*/
...
#define NNCHEAD_NUMNNC_INDEX                                                   \
    0 /*Item 1 in non-neighbour connection header: number of NNCs. Only present for main grid*/
#define NNCHEAD_LGR_INDEX                                                      \
    1 /*Item 2 in non-neighbour connection header: LGR number (0 for global grid)*/
...
#define COORDS_KW                                                              \
    "COORDS" /* The (x,y) coordinates of the top and bottom of the pillars constituting the grid. */
