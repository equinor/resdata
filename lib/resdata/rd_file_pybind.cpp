...
PYBIND11_MODULE(rd_file, m) {
    ...
    py::class_<rd::File>(m, "ResdataFile", py::dynamic_attr())
        .def(py::init([](std::string filename, FileMode flags,
             ...
             "\n"
             "The optional argument flags can be combination of the\n"
             "flags:\n"
             "\n"
             ...
             "      open concurrently.\n"
             "\n"
             "To open the file in both WRITABLE and CLOSE_STREAM mode use\n"
             "\n"
             "   ResdataFile(name, FileMode.WRITABLE | FileMode.CLOSE_STREAM)\n"
             "\n"
        ...
        .def(
            ...
            "\n"
            "There are two restrictions to the use of this function:\n"
            "\n"
            "  1. You can only modify the content of the keyword; if you\n"
            "     try to modify the header in any way (i.e. size, datatype\n"
            "     or name) the function will fail.\n"
            "\n"
            "  2. The keyword you are trying to save must be exactly the\n"
        ...
        .def(
            ...
            "rd_kw still contained in the ResdataFile instance; so that\n"
            "the save_kw function will write it back to file. If the\n"
            "optional argument copy is True the returned kw will be a copy.\n"
            "\n"
