...
int ecl_version_get_major_version() { return ECL_VERSION_MAJOR; }

int ecl_version_get_minor_version() { return ECL_VERSION_MINOR; }

const char *ecl_version_get_micro_version() { return str(ECL_VERSION_MICRO); }
