function(add_python_package target package_path source_files install_package)
  ...
  foreach(file ${source_files})
    ...
    if("$ENV{DESTDIR}" STREQUAL "")
      ...
      set(install_file
          $ENV{DESTDIR}/${CMAKE_INSTALL_PREFIX}/${package_path}/${file})
    endif()

    add_custom_command(
      OUTPUT ${build_file}
      COMMAND ${PYTHON_EXECUTABLE} ARGS ${PROJECT_BINARY_DIR}/bin/cmake_pyc
              ${source_file} ${build_file} ${dependent_target})
    ...
    if(install_package)
      ...
      install(FILES ${build_file}
              DESTINATION ${CMAKE_INSTALL_PREFIX}/${package_path}/${src_path})
      install(
        CODE "execute_process(COMMAND ${PYTHON_EXECUTABLE} ${PROJECT_BINARY_DIR}/bin/cmake_pyc_file ${install_file})"
      )
    endif()
