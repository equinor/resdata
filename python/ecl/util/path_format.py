...
class PathFormat(BaseCClass):
    TYPE_NAME = "path_fmt"
    _alloc = EclPrototype("void* path_fmt_alloc_directory_fmt(char*)", bind = False)
    _str  = EclPrototype("char* path_fmt_get_fmt(path_fmt)")
    _free = EclPrototype("void path_fmt_free(path_fmt)")
