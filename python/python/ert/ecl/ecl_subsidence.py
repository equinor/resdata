...
class EclSubsidence(BaseCClass):
    ...
    _eval_geertsma       = EclPrototype("double ecl_subsidence_eval_geertsma( ecl_subsidence , char* , char* , ecl_region , double , double , double, double, double)")
    ...
    def evalGeertsma(self, base_survey, monitor_survey, pos, youngs_modulus, poisson_ratio, region=None):
