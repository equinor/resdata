...
class EclDataType(BaseCClass):
    ...
    _get_type         = EclPrototype("ecl_type_enum ecl_type_get_type(ecl_data_type)")
    _get_element_size = EclPrototype("size_t ecl_type_get_element_size(ecl_data_type)")
    _is_int           = EclPrototype("bool ecl_type_is_int(ecl_data_type)")
    _is_char          = EclPrototype("bool ecl_type_is_char(ecl_data_type)")
    _is_float         = EclPrototype("bool ecl_type_is_float(ecl_data_type)")
    _is_double        = EclPrototype("bool ecl_type_is_double(ecl_data_type)")
    _is_mess          = EclPrototype("bool ecl_type_is_mess(ecl_data_type)")
    _is_bool          = EclPrototype("bool ecl_type_is_bool(ecl_data_type)")
    _get_type_name    = EclPrototype("char* ecl_type_get_type_name(ecl_data_type)")
    _is_numeric       = EclPrototype("bool ecl_type_is_numeric(ecl_data_type)")
    _is_equal         = EclPrototype("bool ecl_type_is_equal(ecl_data_type, ecl_data_type)")
