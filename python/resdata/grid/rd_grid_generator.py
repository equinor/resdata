...
class GridGenerator:
    ...
    def create_grid(
        ...
        as there is a heuristic in rd_grid.c that marks such cells as tainted.
        ...
        return Grid.create(dims, zcorn, coord, None)
    ...
    def extract_actnum(cls, dims, actnum, ijk_bounds):
        ...
        actnumkw = ResdataKW("ACTNUM", len(new_actnum), ResDataType.RD_INT)
    ...
    def extract_subgrid(
        ...
        @decomposition_change: Depending on the given ijk_bounds, resdata might
        ...
        return Grid.create(sdim, sub_zcorn, sub_coord, sub_actnum, mapaxes=mapaxes)
