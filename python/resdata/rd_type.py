...
import resdata._rd_type as _rd_type
...
class ResDataType(BaseCClass):
    ...
    def __init__(self, type_enum=None, element_size=None, type_name=None):
        ...
        if type_name:
            c_ptr = _rd_type._alloc_from_name(type_name)
        elif element_size is None:
            c_ptr = _rd_type._alloc_from_type(type_enum)
        else:
            c_ptr = _rd_type._alloc(type_enum, element_size)
    ...
    def element_size(self):
        return _rd_type._get_element_size(self)

    @property
    def type_name(self):
        return _rd_type._get_name(self)
