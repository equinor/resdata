...
import resdata.resfile._file_view as _file_view
...
class ResdataFileView(BaseCClass):
    ...
    def __iget(self, index):
        return _file_view._iget_kw(self, index)
    ...
    def iget_named_kw(self, kw_name, index):
        ...
        return _file_view._iget_named_kw(self, kw_name, index)
    ...
    def __len__(self):
        return _file_view._get_size(self)
    ...
    def num_keywords(self, kw):
        return _file_view._get_num_named_kw(self, kw)

    def unique_size(self):
        return _file_view._get_unique_size(self)

    def unique_kw(self):
        return [
            _file_view._get_unique_kw(self, index)
    ...
    def block_view2(self, start_kw, stop_kw, start_index):
        ...
        return _file_view._create_block_view2(self, start_kw, stop_kw, idx)
    ...
    def block_view(self, kw, kw_index):
        ...
        return _file_view._create_block_view(self, kw, kw_index)
