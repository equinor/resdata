...
class SumTest(EclTest):
    ...
    def test_identify_var_type(self):
        self.assertEnumIsFullyDefined(
            EclSumVarType, "ecl_smspec_var_type", "lib/include/ert/ecl/smspec_node.h"
        )
        ...
        self.assertEqual(
            EclSum.varType("RXFT"), EclSumVarType.ECL_SMSPEC_REGION_2_REGION_VAR
        )
        self.assertEqual(
            EclSum.varType("RxxFT"), EclSumVarType.ECL_SMSPEC_REGION_2_REGION_VAR
        )
        self.assertEqual(
            EclSum.varType("RXFR"), EclSumVarType.ECL_SMSPEC_REGION_2_REGION_VAR
        )
        self.assertEqual(
            EclSum.varType("RxxFR"), EclSumVarType.ECL_SMSPEC_REGION_2_REGION_VAR
        )
