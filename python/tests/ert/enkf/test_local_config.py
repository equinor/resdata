...
class LocalConfigTest(ExtendedTestCase):
    ...
    def testLocalConfig(self):
        with ErtTestContext("python/enkf/data/local_config", self.config) as test_context:
            ...
            self._allActive(local_config)
            local_config.clear()
            self._miniStep(local_config, analysis_module)
            self._attachMinistep(local_config)
            self._localDataset(local_config)
            self._localObsdata(local_config)
    ...
    def _allActive(self , local_config):
        updateStep = local_config.getUpdatestep( )
    ...
    def _miniStep( self, local_config, analysis_module ):
        # Ministep
    ...
    def _attachMinistep( self, local_config):
        # Update step
        updatestep = local_config.getUpdatestep( )
    ...
    def _localDataset( self, local_config ):
        # Creating dataset
    ...
    def _localObsdata( self, local_config ):
        # Creating obsdata
    ...
    def _attachObsData( self , local_config):
