...
class GridGeneratorTest(ResdataTest):
    ...
    def test_extract_grid_slice_spec(self):
        ...
        for ijk in ijk_bounds:
            ...
            GridGen.extract_subgrid_data(
                dims, coord, zcorn, ijk, decomposition_change=True
            )
    ...
    def test_actnum_extraction(self):
        ...
        grid = Grid.create(dims, zcorn, coord, actnum)
        ...
        for ijk_bound in ijk_bounds:
            ...
            sub = GridGen.extract_subgrid_data(
                dims, coord, zcorn, ijk_bound, actnum=actnum
            )
