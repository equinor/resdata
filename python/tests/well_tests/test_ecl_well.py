...
class EclWellTest(EclTest):
    ...
    def getWellInfoWithNoWellSegments(self):
        ...
        if EclWellTest.__well_info_with_no_well_segments is None:
            ...
            EclWellTest.__well_info_with_no_well_segments = WellInfo(
                grid, rst_file, False
            )
    ...
    def test_construction(self):
        ...
        well_info = WellInfo(
            grid,
            [EclFile(rst_path_1), EclFile(rst_path_2), rst_path_3, EclFile(rst_path_4)],
        )
        checkWellInfo(
    ...
    def test_well_connection_direction_enum(self):
        ...
        self.assertEnumIsFullyDefined(
            WellConnectionDirectionEnum, "well_conn_dir_enum", source_file_path
        )
    ...
    def test_well_connections(self):
        ...
        for index, connection in enumerate(global_connections):
            ...
            self.assertEqual(
                connection.direction(), WellConnectionDirectionEnum.well_conn_dirX
            )
    ...
    def test_well_connections_msw(self):
        ...
        for index, connection in enumerate(global_connections):
            ...
            self.assertTrue(connection.isMatrixConnection())
            self.assertEqual(
                connection.direction(), WellConnectionDirectionEnum.well_conn_dirY
            )
