...
class GRDECLEquinorTest(ResdataTest):
    ...
    def test_Load(self):
        kw = ResdataKW.read_grdecl(copen(self.src_file, "r"), "PERMX")
        self.assertTrue(kw)

        grid = Grid(self.createTestPath("Equinor/ECLIPSE/Gurbat/ECLIPSE"))
        kw = Resdata3DKW.read_grdecl(grid, copen(self.src_file, "r"), "PERMX")
    ...
    def test_reload(self):
        ...
        kw1 = ResdataKW.read_grdecl(copen(tmp_file1, "r"), "PERMX")
